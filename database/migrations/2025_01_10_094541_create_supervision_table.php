...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('supervision', function (Blueprint $table) {
            $table->id();
            $table->string('v_a_e_d_p_d_t');
            $table->string('a_p_i');
            $table->string('a_p_m');
            $table->string('a_d_q_d_i');
            $table->string('d_d_i_p');
            $table->string('p_d_a_s_a');
            $table->string('l_d_r_p_d');
            $table->string('l_d_p_m_p');
            $table->string('l_d_p_p_l');
            $table->string('l_d_p_c_r');
            $table->string('r_n_p_ats_1');
            $table->string('r_n_p_ats_2');
            $table->string('r_n_p_ats_3');
            $table->string('i_e_s_r_1');
            $table->string('i_e_s_r_2');
            $table->string('i_e_s_r_3');
            $table->string('a_d_a_d_t_1');
            $table->string('a_d_a_d_t_2');
            $table->string('a_d_a_d_t_3');
            $table->string('r_d_t_p_s_1');
            $table->string('r_d_t_p_s_2');
            $table->string('r_d_t_p_s_3');
            $table->string('t_d_s_d_t_1');
            $table->string('t_d_s_d_t_2');
            $table->string('t_d_s_d_t_3');
            $table->string('c_d_c_d_c_1');
            $table->string('c_d_c_d_c_2');
            $table->string('c_d_c_d_c_3');
            $table->string('p_c_c_r_1');
            $table->string('p_c_c_r_2');
            $table->string('p_c_c_r_3');
            $table->string('p_c_c_r_4');
            $table->string('c_d_c_d_c_4');
            $table->string('c_d_c_d_c_5');
            $table->string('c_d_c_d_c_6');
            $table->string('t_d_p_r_n_1');
            $table->string('t_d_p_r_n_2');
            $table->string('t_d_p_r_n_3');
            $table->string('r_d_t_d_r_1');
            $table->string('r_d_t_d_r_2');
            $table->string('r_d_t_d_r_3');
            $table->string('r_d_g_e_t_1');
            $table->string('r_d_g_e_t_2');
            $table->string('r_d_g_e_t_3');
            $table->string('r_d_e_d_p_1');
            $table->string('r_d_e_d_p_2');
            $table->string('r_d_e_d_p_3');
            $table->string('d_c_d_d_e_1');
            $table->string('d_c_d_d_e_2');
            $table->string('d_c_d_d_e_3');
            $table->string('r_c_d_n_d_1');
            $table->string('r_c_d_n_d_2');
            $table->string('r_c_d_n_d_3');
            $table->string('p_n_ds_n_f_1');
            $table->string('p_n_ds_n_f_2');
            $table->string('p_n_ds_n_f_3');
            $table->string('p_n_dd_vs_1');
            $table->string('p_n_dd_vs_2');
            $table->string('p_n_dd_vs_3');
            $table->integer('p_p_d_d_i');
            $table->integer('p_p_r_h');
            $table->integer('p_p_v_s_o_1');
            $table->integer('p_p_v_s_o_2');
            $table->integer('p_p_v_s_o_3');
            $table->integer('p_p_a_q_d_1');
            $table->integer('p_p_a_q_d_2');
            $table->integer('p_p_a_q_d_3');
            
            //Dicionario dos strings acima codificados
